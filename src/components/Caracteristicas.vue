        ...
        <div class="product-dim-element">
            ...
            <div class="product-dim-input--list">
                ...
                <md-field>
                    ...
                    <md-select :value="distance_unit" name="distance_unit" id="distance_unit" @input="(e)=>set_value_input(e,'distance_unit')">
            ...
            <div class="product-dim-input--list margin-top">
                ...
                <md-field>
                    ...
                    <md-select :value="mass_unit" name="mass_unit" id="mass_unit" @input="(e)=>set_value_input(e,'mass_unit')">
        ...
        <div class="product-attr-element">
            ...
            <div class="product-attr-input--list">
                <md-field>
                    ...
                    <md-select :value="sizes" name="sizes" id="sizes" @input="(e)=>set_value_input(e,'sizes')">
                        <md-option :value="size" v-for="size in sizes" :key="size">{{size}}</md-option>
                    </md-select>
                </md-field>
                <md-field>
                    <label for="color">Color</label>
                    <md-select :value="colors" name="colors" id="colors" @input="(e)=>set_value_input(e,'colors')">
